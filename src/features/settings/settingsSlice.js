...
const initialState = {
    calendarByDistrictView:
        localStorage.getItem(settingsMap.calendarByDistrictView) ||
        defaultSettings.calendarByDistrictView,
    calendarByDistrictAutoRefresh:
        localStorage.getItem(settingsMap.calendarByDistrictAutoRefresh) ===
            "true" || defaultSettings.calendarByDistrictAutoRefresh,
    calendarByDistrictAutoRefreshInterval:
        parseInt(
            localStorage.getItem(
                settingsMap.calendarByDistrictAutoRefreshInterval
            )
    ...
    reducers: {
        resetSettings: (state, action) => {
            ...
            localStorage.setItem(
                settingsMap.calendarByDistrictView,
                defaultSettings.calendarByDistrictView
            );
            localStorage.setItem(
                settingsMap.calendarByDistrictAutoRefresh,
            ...
            state.calendarByDistrictView =
                defaultSettings.calendarByDistrictView;
            state.calendarByDistrictAutoRefresh =
                defaultSettings.calendarByDistrictAutoRefresh;
            state.calendarByDistrictAutoRefreshInterval =
                defaultSettings.calendarByDistrictAutoRefreshInterval;
        },
        ...
        setCalendarByDistrictAutoRefreshInterval: (state, action) => {
            ...
            if (interval === null) {
                ...
                localStorage.setItem(
                    "SETTINGS_CALENDARBYDIST_AR_INT",
                    interval.toString()
                );
            }
        },
